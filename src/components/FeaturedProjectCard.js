...
export default function ProjectCard({ title, description, imageSrc, link, tags, badge }) {
  return (
    <article className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.02] shadow-[0_20px_45px_rgba(5,6,25,0.35)] transition-all duration-700 hover:border-purple-300/40 hover:shadow-[0_28px_80px_rgba(89,70,255,0.22)] supports-[backdrop-filter]:bg-white/[0.05] backdrop-blur-0 group-hover:backdrop-blur-sm">
