...
export function HomeCarousel() {
    ...
    return <>
        ...
        <div className="flex justify-between mt-6">
            <button
                onClick={prevPage}
                className={`flex items-center gap-2 py-2 bg-gray-100 transition-opacity duration-500 ${page === 0 ? "opacity-20 pointer-events-none" : "opacity-100"
                    }`}
            >
            ...
            <button
                onClick={nextPage}
                className={`flex items-center gap-2py-2 bg-gray-100 transition-opacity duration-500 ${page === 1 ? "opacity-20 pointer-events-none" : "opacity-100"
                    }`}
            >
